...
golem::add_module(name = "mapa_principal", with_test = TRUE) # Name of the module
golem::add_module(name = "resultados", with_test = FALSE)
golem::add_module(name = "enc_salida", with_test = FALSE)
...
usethis::use_data_raw(name = "correcciones", open = FALSE)
usethis::use_data_raw(name = "estratos_casillas", open = TRUE)
usethis::use_data_raw(name = "entregable_encuesta_salida", open = TRUE)
usethis::use_data_raw(name = "entregable_conteo_rapido", open = TRUE)
...
## Vignette ----
usethis::use_vignette("tablero_bajaCalifornia_diaD_2024")
